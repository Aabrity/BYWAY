...
export default function PackageInputForm() {
  ...
  return (
    <div className=" flex justify-center w-full">
      {auth ? (
        <div className="h-auto overflow-hidden bg-gray-100 py-5 w-[90%] mt-14 rounded-xl">
          <div className="max-h-[80vh] overflow-y-auto bg-gray-100 px-14 py-10">
            ...
            <div className="mt-40 flex flex-col justify-center w-full overflow-x-auto">
              <PackageTable />
            </div>
          </div>
        </div>
