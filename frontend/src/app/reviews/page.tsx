...
function PlanTrip() {
  ...
  useEffect(() => {
    Axios.get('http://localhost:3001/api/get/review')
      .then((response) => {
  ...
  const submit=()=>{
    ...
    Axios.post("http://localhost:3001/api/insert/review",{fullName:fullName,selectCountry:selectCountry,date:date,title:title,reviewDetails:reviewDetails
  ...
  1
    ...
    setReviewList([
      ...reviewList, 
      {fullName:fullName,selectCountry:selectCountry,date:date,title:title,reviewDetails:reviewDetails},
    ]);
